...
void EdgeNavStatePR::computeError()
{
    ...
    const NavState M = _measurement;
    Vector3d dPij = M.Get_P();    // Delta Position pre-integration measurement
    SO3Type dRij = M.Get_R();  // Delta Rotation pre-integration measurement
