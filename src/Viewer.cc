...
void Viewer::Run()
{
    ...
    pangolin::Var<bool> menuLoad("menu.Load Map",false,false);
    ...
    while(1)
    {
        ...
        if(menuGlobalBA)
	{
	    mpSystem->ActiveGlobalBA();
	}
	else if(!menuGlobalBA)
	{
	    mpSystem->DeactiveGlobalBA();
	}
	...
	{
	    mpMapDrawer->DrawAllLidarPoints();
	}
