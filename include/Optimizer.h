...
public:
    ...
    int static PoseOptimization(Frame *pFrame, KeyFrame* pLastKF, ICPer& icper, const bool& bComputeMarg=false);
    int static PoseOptimization(Frame *pFrame, Frame* pLastFrame, ICPer& icper, const bool& bComputeMarg=false);
...
public:
    ...
    static bool cmpKF(KeyFrame* pKF1, KeyFrame* pKF2){
