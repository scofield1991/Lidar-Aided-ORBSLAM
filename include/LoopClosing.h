...
public:
    ...
    void DoGlobalBAFlag(const bool bflag);
...
public:
    ...
    LoopClosing(Map* pMap, KeyFrameDatabase* pDB, ORBVocabulary* pVoc,const bool bFixScale, ConfigParam* pParams, LidarMap* pLidarMap);
