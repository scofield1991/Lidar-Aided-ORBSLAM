...
public:
    ...
    // Flag for global BA
    bool globalOptimized;
    
    // Predict the NavState of Current Frame by Odom
    void PredictNavStateByLidar(bool bMapUpdated);
    ICPer icper;

    bool TrackWithLidar(bool bMapUpdated=false);
    bool TrackLocalMapWithLidar(bool bMapUpdated=false);

    ConfigParam* mpParams;    
    cv::Mat GrabImageStereoLidar(const cv::Mat &imLeft, 
